...
type GreetServiceClient interface {
	...
	SayHelloServiceStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (GreetService_SayHelloServiceStreamingClient, error)
...
func (c *greetServiceClient) SayHelloServiceStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (GreetService_SayHelloServiceStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet_service.GreetService/SayHelloServiceStreaming", opts...)
	if err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloServiceStreaming(*NameList, GreetService_SayHelloServiceStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloServiceStreaming(*NameList, GreetService_SayHelloServiceStreamingServer) error {
